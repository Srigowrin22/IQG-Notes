...
public class VoteDialog extends JPanel 
{
	...
	{
        	this.frame = frame;
        	JLabel title = new JLabel("Click the \"Vote\" button once you have selected a candidate.",
                           JLabel.CENTER);
    	...
    	private JPanel createSimpleDialogBox() 
	{
        ...
        voteButton.addActionListener(new ActionListener() {
                ...
                } else if (command == yeahNahCommand) 
		    {
                    ...
                    if (n == JOptionPane.YES_OPTION)		setLabel("Excellent choice.");
                    else if (n == JOptionPane.NO_OPTION)	setLabel("Whatever you say. It's your vote.");
                    else if (n == JOptionPane.CANCEL_OPTION)setLabel("Well, I'm certainly not going to make you vote.");
                    else						setLabel("It is your civic duty to cast your vote.");
                }
                return;
            }
        });
    	...
    	private JPanel createPane(String description, JRadioButton[] radioButtons, JButton showButton) 
	{
        ...
        for (int i = 0; i < numChoices; i++) 	box.add(radioButtons[i]);
