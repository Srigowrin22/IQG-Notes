...
public interface AdminRepository extends JpaRepository<AdminEO, String> {
    ...
    List<AdminEO> findByRoleRoleId(Long roleId);

    Optional<AdminEO> findByDesignationId(String designationId);

	List<AdminEO> findByName(String name);

	Optional<AdminEO> findByAadhar(String aadhar);
