...
public class AdminServiceImpl implements AdminService {
	...
	public AdminDTO persistAdminEO(AdminEO adminEO) {
	    ...
	    if (adminRepositoryRef.findByDesignationId(adminEO.getDesignationId()).isPresent()) {
	        throw new RuntimeException("Admin already exists with designationId: " + adminEO.getDesignationId());
	    }
